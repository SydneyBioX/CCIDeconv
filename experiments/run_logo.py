...
from utils import process_data, rf_cv, cast_params, xgbc_cv, xgb_reg
...
def main(args):
    ...
    Performs Leave-One-Group-Out (LOGO) cross-validation experiments for spatial transcriptomics (ST) datasets.
    ...
    Example usage:
    logo training with sptatial information
    ...
    logo training without sptatial information
    python experiments/run_logo.py \
        --data_path data/training_data/training_data.csv \
        --categorical_columns lr_pair,source,target,pathway_name,annotation,ligand.family,ligand.keyword,ligand.secreted_type,ligand.transmembrane,receptor.family,receptor.keyword,receptor.surfaceome_main,receptor.surfaceome_sub,receptor.adhesome,receptor.secreted_type,receptor.transmembrane \
        --group_column sample
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run LOGO experiment")
    ...
    parser.add_argument("--spatial", action='store_true', help="Whether to include spatial information")
    args = parser.parse_args()
    
    main(args)
    
# example command to run: logo training with sptatial information
# python experiments/run_logo.py \
#     --data_path data/training_data/training_data.csv \
#     --categorical_columns lr_pair,source,target,pathway_name,annotation,ligand.family,ligand.keyword,ligand.secreted_type,ligand.transmembrane,receptor.family,receptor.keyword,receptor.surfaceome_main,receptor.surfaceome_sub,receptor.adhesome,receptor.secreted_type,receptor.transmembrane \
#     --group_column sample\
...
# example command to run: logo training without sptatial information
# python experiments/run_logo.py \
#     --data_path data/training_data/training_data.csv \
#     --categorical_columns lr_pair,source,target,pathway_name,annotation,ligand.family,ligand.keyword,ligand.secreted_type,ligand.transmembrane,receptor.family,receptor.keyword,receptor.surfaceome_main,receptor.surfaceome_sub,receptor.adhesome,receptor.secreted_type,receptor.transmembrane \
#     --group_column sample
